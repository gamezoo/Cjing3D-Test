...
project (PROJECT_RESOURCE_NAME)
    ...
    targetname(PROJECT_RESOURCE_NAME)

    -- dependencies
    setup_dependencies(PROJECT_RESOURCE_NAME)
    ...
    filter {"configurations:Debug"}
        ...
        defines { "DEBUG" }
        setup_dependent_libs(PROJECT_RESOURCE_NAME, "Debug")

    -- Release config
    filter {"configurations:Release"}
        targetdir ("lib/" .. platform_dir .. "/Release")
        defines { "NDEBUG" }
        setup_dependent_libs(PROJECT_RESOURCE_NAME, "Release")